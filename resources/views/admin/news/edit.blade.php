...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="tile" action="{{ route('admin.news.edit') }}" method="post" enctype="multipart/form-data"
                novalidate>
                @csrf
                @method("PUT")
                ...
                <div class="tile-body">
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control" type="text" name="news_name" value="{{old('news_name') ?? $news_detail->ten_tin_tuc}}">
                            @error('news_name')
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control" type="text" name="news_des" value="{{old('news_des') ?? $news_detail->mo_ta_tin_tuc}}">
                            @error('news_des')
                                <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" name="news_ctg">
                                @foreach ($list_new_ctg as $new_ctg)
                                    <option value="{{ $new_ctg->id }}" @if ($new_ctg->id == $news_detail->id_danh_muc_tin_tuc) selected @endif>
                        ...
                        <div class="form-group col-md-4">
                            <img style="object-fit: cover" width="100" height="100"
                                src="{{ asset('storage/' . $news_detail->anh) }}"
                                alt="{{ $news_detail->ten_tin_tuc }}">
                        </div>
                    </div>
                </div>
